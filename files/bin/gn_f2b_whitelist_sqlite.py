...
IGNORES_HEADER = """
# This file is generated by script /usr/local/bin/gn_f2b_whitelist_sqlite.py

# Check and copy/move this draft file to gn-ignoreip.local.

# Make use of 'ignoreip_local' varialbe in your configuration by adding this line to your config:
# ignoreip = ...your_ips... %(ignoreip_local)s
# or rename 'ignoreip_local' to 'ignoreip' if you don't have 'ignoreip' variable used already.
